...
export const routes: Routes = [
  ...
  { path: 'ai-summaries', canActivate: [authGuard], loadComponent: () => import('./pages/ai-summaries/ai-summaries.page').then(m => m.AiSummariesPage) },
  { path: 'ai-flashcards', canActivate: [authGuard], loadComponent: () => import('./pages/ai-flashcards/ai-flashcards.page').then(m => m.AiFlashcardsPage) },
  { path: 'quiz-history', canActivate: [authGuard], loadComponent: () => import('./pages/quiz-history/quiz-history.page').then(m => m.QuizHistoryPage) },
  { path: 'ai-chat-history', canActivate: [authGuard], loadComponent: () => import('./pages/ai-chat-history/ai-chat-history.page').then(m => m.AiChatHistoryPage) },
